      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-10">
        ...
        <nav className="mb-10 bg-slate-50 p-4 rounded-xl border border-slate-100">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {sections.map(s => (
              <li key={s.id} className="text-sm text-slate-600 font-medium flex items-center gap-2">
        ...
        <div className="space-y-12 text-slate-600 leading-relaxed">
          {/* Settings Section */}
          <section id="settings" className="bg-indigo-50/50 p-6 rounded-2xl border border-indigo-100/50 scroll-mt-20">
          ...
          <section id="intro" className="scroll-mt-20">
            ...
            <p>Cet outil gratuit vous permet de réaliser les calculs de pourcentage les plus courants de manière instantanée. Que ce soit pour des remises commerciales, des évolutions de budget ou des déclarations de TVA, <strong>CalculerUnPourcentage</strong> garantit rapidité et précision.</p>
          ...
          <section id="part" className="scroll-mt-20">
          ...
          <section id="variation" className="scroll-mt-20">
            <h3 className="text-xl font-bold text-slate-900 mb-3">Taux de variation</h3>
            <p className="mb-2"><strong>À quoi ça sert :</strong> Mesurer l'évolution en pourcentage entre deux valeurs (ex: "Le prix est passé de 100€ à 150€, quelle est l'augmentation ?").</p>
            <p className="mb-2"><strong>Formule :</strong> <code>Taux = ((Valeur Finale - Valeur Initiale) / Valeur Initiale) × 100</code></p>
            <div className="bg-slate-50 p-3 rounded-lg text-sm border-l-4 border-indigo-500">
              <strong>Exemple :</strong> De 100 à 150 = +50%
            </div>
          </section>

          <section id="total" className="scroll-mt-20">
          ...
          <section id="tva" className="scroll-mt-20">
          ...
          <section id="privacy" className="pt-6 border-t border-slate-100 scroll-mt-20">
